...
module maindec(input        rst,
  ...
  always @(*) begin
    ...
    MemRead:	begin
      controls <= 11'b00_00_00_10_000;
    end
    MemWB:	begin
      controls <= 11'b00_00_00_01_100;
    end
    MemW:	begin
      controls <= 11'b10_01_00_10_010;
    end
    ALUWB:	begin
    ...
    LUI: begin
      controls <= 11'b00_00_00_11_100;
    end
    JALR: begin	
      controls <= 11'b10_01_01_00_000;
      ALUOp <= 1;
    end
    JALRWB: begin	
      controls <= 11'b01_10_00_00_100;
      ALUOp <= 1;
    end
    default: begin
  ...
  always @(*) begin
    ...
    begin
      ...
      else if (opcode == `OP_I_Load || opcode == `OP_S) n_state <= MemAdr;
...
module datapath(input         clk, reset_n, // clock and reset signals
  ...
  begin
    if      (ALUSrcB == 2'b00) alusrc2[31:0] = rs2_data_reg;
      ...
      if      (opcode == `OP_U_LUI | opcode == `OP_U_AUIPC)   alusrc2[31:0] = auipc_lui_imm[31:0];
      else if (opcode == `OP_S)                               alusrc2[31:0] = se_imm_stype[31:0];
      else if (opcode == `OP_B)                               alusrc2[31:0] = se_br_imm[31:0];
      else if (opcode == `OP_I_Arith | opcode == `OP_I_Load)  alusrc2[31:0] = se_imm_itype[31:0];
      else if (opcode == `OP_J_JAL)                           alusrc2[31:0] = se_jal_imm[31:0];
...
module RV32I (
  ...
  begin
    ...
    begin
 /********** TODO **********/
      inst_reg <= inst; // 현재 명령어를 inst_reg에 저장
	  OldPC <= pc;      // 이전 PC 값을 OldPC에 저장
    end
  end
